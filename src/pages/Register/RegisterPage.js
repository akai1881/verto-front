...
const RegisterPage = () => {
  ...
  useEffect(() => {
    ...
    if (isSuccess) {
      dispatch(clearState());
      openNotification('success', 'На вашу почту отправлено письмо с активацией');
      history.push('/');
    }
  }, [isSuccess, isError]);
            ...
            <div className={styles.register_names}>
              <div className={styles.input_item}>
                ...
                <input
                  ...
                  {...register('first_name')}
                />
                <p className={styles.validate_error}>{errors.first_name?.message}</p>
              </div>
              ...
              <div className={styles.input_item}>
                ...
                <input
                  ...
                  {...register('last_name')}
                />
                <p className={styles.validate_error}>{errors.last_name?.message}</p>
              </div>
            </div>
            <div className={styles.input_item}>
              <div className={styles.register_email_label}>Адрес электронной почты</div>
              <input
                className={clsx({
                  [styles.input]: true,
