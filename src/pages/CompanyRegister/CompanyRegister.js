...
const CompanyRegister = () => {
  ...
  useEffect(() => {
    ...
    if (isSuccess) {
      ...
      openNotification(
        'success',
        'На вашу почту отправлено письмо с активацией аккаунта'
      );
      history.push('/');
    }
  }, [isSuccess, isError]);
        ...
        >
          ...
          <div className={styles.flex}>
            <div className={styles.column}>
              ...
              <div className={styles.input_item}>
                <div className={styles.register_email_label}>
                  Юридический электронный адрес организации
                </div>
                <input
                  className={clsx({
                    [styles.input]: true,
            ...
            <div className={styles.column}>
              <div className={styles.input_item}>
                <div className={styles.register_email_label}>
                  Юридический номер телефона организации
                </div>
                <input
                  className={clsx({
                    [styles.input]: true,
