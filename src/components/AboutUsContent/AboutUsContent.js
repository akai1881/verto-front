    ...
    return (
        ...
        <Container>
            ...
            <p>компаний на сайте</p>
             ...
             <div><span>50 тыс +</span>
             <p>посетителей в сутки</p></div> 
             <div><span>120 +</span><p>сделок в день</p></div> 
             <div><span>12 млн +</span><p>товаров на сайте</p></div> 
             </div>
             <p className='about-us-title'>Наши преимущества</p>
             <div className='about-us-images'>
                 <div><img src={AboutUsImg1}/><span>более 15%</span><span>Lorem Ipsum Dolores Se</span></div>
                 <div><img src={AboutUsImg2}/><span>100% гарантия</span><span>Lorem Ipsum Dolores Se</span></div>
